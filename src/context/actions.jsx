...
export const appendMessage = ({ date, from, color, text, message_id, replyingTo, filesToSubmit, attachments }) => {
  return {
    type: '@chat/appendMessage',
    payload: { date, from, color, text, message_id, replyingTo, filesToSubmit, attachments }
  };
};
